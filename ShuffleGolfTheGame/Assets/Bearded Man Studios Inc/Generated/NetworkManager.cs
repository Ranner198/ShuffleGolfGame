...
namespace BeardedManStudios.Forge.Networking.Unity
{
	public partial class NetworkManager : MonoBehaviour
	{
		...
		public GameObject[] PlayerPuckNetworkObject = null;
		public GameObject[] TestNetworkObject = null;
		public GameObject[] ServerManagerNetworkObject = null;
		...
		private void CaptureObjects(NetworkObject obj)
		{
				...
				MainThreadManager.Run(() =>
				{
					...
					if (!NetworkBehavior.skipAttachIds.TryGetValue(obj.NetworkId, out newObj))
					{
						if (PlayerCharacterNetworkObject.Length > 0 && PlayerCharacterNetworkObject[obj.CreateCode] != null)
						{
							...
							newObj = go.GetComponent<PlayerCharacterBehavior>();
						}
					}
			...
			else if (obj is PlayerPuckNetworkObject)
			{
				MainThreadManager.Run(() =>
				{
					NetworkBehavior newObj = null;
					if (!NetworkBehavior.skipAttachIds.TryGetValue(obj.NetworkId, out newObj))
					{
						if (PlayerPuckNetworkObject.Length > 0 && PlayerPuckNetworkObject[obj.CreateCode] != null)
						{
							var go = Instantiate(PlayerPuckNetworkObject[obj.CreateCode]);
							newObj = go.GetComponent<PlayerPuckBehavior>();
						}
					}
			...
			else if (obj is ServerManagerNetworkObject)
			{
				MainThreadManager.Run(() =>
				{
					NetworkBehavior newObj = null;
					if (!NetworkBehavior.skipAttachIds.TryGetValue(obj.NetworkId, out newObj))
					{
						if (ServerManagerNetworkObject.Length > 0 && ServerManagerNetworkObject[obj.CreateCode] != null)
						{
							var go = Instantiate(ServerManagerNetworkObject[obj.CreateCode]);
							newObj = go.GetComponent<ServerManagerBehavior>();
						}
					}
		...
		[Obsolete("Use InstantiatePlayerPuck instead, its shorter and easier to type out ;)")]
		public PlayerPuckBehavior InstantiatePlayerPuckNetworkObject(int index = 0, Vector3? position = null, Quaternion? rotation = null, bool sendTransform = true)
		{
			var go = Instantiate(PlayerPuckNetworkObject[index]);
			var netBehavior = go.GetComponent<PlayerPuckBehavior>();
			var obj = netBehavior.CreateNetworkObject(Networker, index);
			go.GetComponent<PlayerPuckBehavior>().networkObject = (PlayerPuckNetworkObject)obj;
		...
		[Obsolete("Use InstantiateServerManager instead, its shorter and easier to type out ;)")]
		public ServerManagerBehavior InstantiateServerManagerNetworkObject(int index = 0, Vector3? position = null, Quaternion? rotation = null, bool sendTransform = true)
		{
			var go = Instantiate(ServerManagerNetworkObject[index]);
			var netBehavior = go.GetComponent<ServerManagerBehavior>();
			var obj = netBehavior.CreateNetworkObject(Networker, index);
			go.GetComponent<ServerManagerBehavior>().networkObject = (ServerManagerNetworkObject)obj;
		...
		/// <summary>
		/// Instantiate an instance of PlayerCharacter
		/// </summary>
		/// <returns>
		/// A local instance of PlayerCharacterBehavior
		/// </returns>
		/// <param name="index">The index of the PlayerCharacter prefab in the NetworkManager to Instantiate</param>
		/// <param name="position">Optional parameter which defines the position of the created GameObject</param>
		/// <param name="rotation">Optional parameter which defines the rotation of the created GameObject</param>
		/// <param name="sendTransform">Optional Parameter to send transform data to other connected clients on Instantiation</param>
		...
		/// <summary>
		/// Instantiate an instance of PlayerPuck
		/// </summary>
		/// <returns>
		/// A local instance of PlayerPuckBehavior
		/// </returns>
		/// <param name="index">The index of the PlayerPuck prefab in the NetworkManager to Instantiate</param>
		/// <param name="position">Optional parameter which defines the position of the created GameObject</param>
		/// <param name="rotation">Optional parameter which defines the rotation of the created GameObject</param>
		/// <param name="sendTransform">Optional Parameter to send transform data to other connected clients on Instantiation</param>
		public PlayerPuckBehavior InstantiatePlayerPuck(int index = 0, Vector3? position = null, Quaternion? rotation = null, bool sendTransform = true)
		{
			var go = Instantiate(PlayerPuckNetworkObject[index]);
			var netBehavior = go.GetComponent<PlayerPuckBehavior>();
		...
		/// <summary>
		/// Instantiate an instance of ServerManager
		/// </summary>
		/// <returns>
		/// A local instance of ServerManagerBehavior
		/// </returns>
		/// <param name="index">The index of the ServerManager prefab in the NetworkManager to Instantiate</param>
		/// <param name="position">Optional parameter which defines the position of the created GameObject</param>
		/// <param name="rotation">Optional parameter which defines the rotation of the created GameObject</param>
		/// <param name="sendTransform">Optional Parameter to send transform data to other connected clients on Instantiation</param>
		public ServerManagerBehavior InstantiateServerManager(int index = 0, Vector3? position = null, Quaternion? rotation = null, bool sendTransform = true)
		{
			var go = Instantiate(ServerManagerNetworkObject[index]);
			var netBehavior = go.GetComponent<ServerManagerBehavior>();
